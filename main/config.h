...
#define _Instructions "ChessPlayer/feeds/cetaiotrobot31415.instructions"
...
bool _CarnavalTurn = false;
bool _TurnOnRecive = false;
bool _ModAllSpeeds = false;

//config for selecting movement code 
enum PossibleLineFollowingLogics {NICHOLAS, MUNJAL, ADRIAN, REVUP, SHOWCASE, CARNAVAL, DRIVE}; //Adrian: 44s, Munjal: 21, Nick: 22s
enum PossibleLineFollowingLogics _CurrentLineFollowingLogic = DRIVE;
